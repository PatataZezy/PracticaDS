...
import baseNoStates.AreaVisitors.GetSpacesInAreaVisitor;
...
public class RequestArea implements Request {
  ...
  public void process() {
    ...
    // processed later
    GetSpacesInAreaVisitor getSpacesInAreaVisitor = new GetSpacesInAreaVisitor(areaId);
    DirectoryAreas.acceptTreeVisitor(getSpacesInAreaVisitor);
    // an Area is a Space or a Partition
    for (Space space : getSpacesInAreaVisitor.getResult()) {
      ...
      for (baseNoStates.Door door : space.getDoorsGivingAccess()) {
